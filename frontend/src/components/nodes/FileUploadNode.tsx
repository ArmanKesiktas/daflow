  ...
  return createPortal(
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <h4 className="text-[12px] font-semibold text-[#1d1d1f] dark:text-white">Data Preview</h4>
...
export const FileUploadNode = memo(function FileUploadNode({ id, data, selected }: NodeProps<Node<NodeData>>) {
